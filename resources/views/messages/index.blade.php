    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Mis Mensajes</h1>
                    <p class="text-gray-600">Gestiona tus conversaciones con el administrador</p>
                </div>
                ...
                <div class="border-b border-gray-200">
                    <nav class="-mb-px flex space-x-8">
                        <a href="{{ route('messages.index') }}" 
                           class="py-2 px-1 border-b-2 font-medium text-sm {{ request()->routeIs('messages.index') && !request('tab') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            Recibidos ({{ $messages->total() }})
                        </a>
                        <a href="{{ route('messages.sent') }}" 
                           class="py-2 px-1 border-b-2 font-medium text-sm {{ request()->routeIs('messages.sent') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            Enviados
                        </a>
                    </nav>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                @if($messages->isEmpty())
                    <div class="p-8 text-center">
                        ...
                        <p class="text-gray-500 text-lg mb-2">No tienes mensajes</p>
