...
Route::get('/direct-password-reset', [DirectPasswordResetController::class, 'showForm'])->name('direct-password-reset.form');
Route::post('/direct-password-reset/check', [DirectPasswordResetController::class, 'checkEmail'])->name('direct-password-reset.check');
Route::post('/direct-password-reset/update', [DirectPasswordResetController::class, 'updatePassword'])->name('direct-password-reset.update');
